...
public class GameProgress
{
    ...
    public static void LevelComplete(int level) => levelLastCompleted = levelLastCompleted == level - 1 ? level : levelLastCompleted;

    //if the completed tutorial was the lastest tutorial, increase tutorialCompleted index
    public static void TutorialComplete(int tutorial) => tutorialLastCompleted = tutorialLastCompleted == tutorial-1 ? tutorial : tutorialLastCompleted;
